  ...
  <div class="userManagement-container">
    ...
    >
      ...
      <el-table-column
        ...
        label="药品名称"
      ></el-table-column>
      <el-table-column show-overflow-tooltip label="规格" width="50">
...
<script>
  import { getList, doDelete } from '@/api/Drug_StandardBuyManagement'
  import Edit from './components/StandardBuyEdit'

  export default {
    name: 'DrugManagementStandardBuy',
    components: { Edit },
    data() {
      return {
        list: null,
